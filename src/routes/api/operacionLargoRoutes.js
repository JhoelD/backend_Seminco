...
router.get('/largo/ultima', verificarToken, OperacionController.obtenerUltimaOperacionTaladroLargo);
...
router.get('/horizontal/ultima',verificarToken,  OperacionController.obtenerUltimaOperacionTaladroHorizontal);
...
router.get('/sostenimiento/ultima', verificarToken, OperacionController.obtenerUltimaOperacionTaladroSostenimiento);
