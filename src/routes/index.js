...
const mediHorizontalProgramado = require('../routes/api/medicionesHorizontalProgramadoRoutes');
...
router.use('/medicion-tal-horizontal-programado', mediHorizontalProgramado); 
